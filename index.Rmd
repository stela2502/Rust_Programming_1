...
You should only use Rust if a process you frequently use takes a lot of time. Rust in general is easily 10 times faster than R or Python. In general you can compare Rust with C and C++, but programming in Rust is WAY easier than programming in C or C++.

Why? Because the Rust compiler is a work of art. We will come to that - soon!
