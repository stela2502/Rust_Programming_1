...
Get rid of the previous folder:
...
I have choosen the kind of string we all likely work most with: DNA.
And as I am currently trying to implement a genome matcher I was thinking of compacting DNA sequences and make them 'numeric'. I am of cause not the first to have this problem and therefore here is some code from the combine lab:
...
This function is meant as an additional feature here. You do not need to completely understand that. I totally recommend you to let ChatGPT explain that function to you ;-). And I hope you can use something like that later on.
