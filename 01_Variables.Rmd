...
This is code working in RStudio is you install the rextendr R package. I used this here simply to show you how variables are defined and how to break this simple logics.


(Using RStudio at the moment) I now can actually look into what the variables contain using an externdr R code:
...
This is Rust code interpreted by R. Therefore you need to use the Rust way to define variables using "let <varname> = <value>".
...
Rust is a compiled language and therefore interacting with it using a jupyter notebook or Rmd file does limit the languae a lot.
Therefore it makes more sense to compile Rust programs and use them on the command line. 
