...
The next part reads the command line options into the program:
...
This leaves us with the final 'work' the tool does is in these lines:
...
- lines 0..9 define the dependencies
...
Here we define the class contents and return a Self object - special focus on the missing ';' in the end...
